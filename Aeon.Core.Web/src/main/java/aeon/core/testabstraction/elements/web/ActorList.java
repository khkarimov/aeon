 ...
 */
public class ActorList<T extends ComponentList> {

    public T rowBy;

    /**
     * Creates a new instance of {@link ActorList}.
     *
     ...
     */
    public ActorList(AutomationInfo automationInfo, IByWeb selector, T rowBy) {
        this.rowBy = rowBy;

...
public class ListGroup<T extends ListGroupActions> {
     ...
     */
    public ListGroup(AutomationInfo automationInfo, IByWeb selector, T rowBy) {
        this.rowBy = rowBy;
     ...
     * @param rowBy The {@link ListGroupActions} object to use for list group actions
     */
    public ListGroup(AutomationInfo automationInfo, IByWeb selector, Iterable<IByWeb> switchMechanism, T rowBy) {
        this.rowBy = rowBy;

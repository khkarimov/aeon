...
public class NotVisibleCommandTests {
    ...
    private NotVisibleCommand command;

    @Before
    public void setUp() {
        command = new NotVisibleCommand(selector, commandInitializer);
    }
    ...
    public void notVisibleCommand_CallsExecute() {
        ...
        //Assert
        verify(driver, times(1)).notVisible(control);
    }
}

...
import aeon.selenium.appium.common.mobile.interfaces.INativeById;

/**
 * Class for selecting elements (default is via a CSS selector).
 */
public class NativeById implements INativeById {

    private String selector;

    /**
     * Initializes a new instance of the {@link NativeById} class.
     *
     * @param selector The CSS selector.
     */
    protected NativeById(String selector) {
     ...
     * @return A new {@link NativeById} instance.
     */

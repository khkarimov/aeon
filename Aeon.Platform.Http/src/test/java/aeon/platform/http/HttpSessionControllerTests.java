...
//    @Before
//    public void setUp() {
//        httpSessionController = new HttpSessionController(sessionFactoryMock, commandServiceMock);
//        httpSessionController.setSessionTable(sessionTableMock);
//    }
//
//    @Test
//    public void createSessionTest() throws Exception {
//        when(sessionFactoryMock.createSessionId()).thenReturn(sessionIdMock);
//        when(sessionFactoryMock.setUpAutomationInfo(null)).thenReturn(automationInfoMock);
//        when(sessionFactoryMock.setUpCommandExecutionFacade(automationInfoMock)).thenReturn(commandExecutionFacadeMock);
//
//        ResponseEntity response = httpSessionController.createSession(createSessionBodyMock);
//
//        verify(sessionFactoryMock, times(1)).setUpAutomationInfo(null);
//        verify(sessionFactoryMock, times(1)).setUpCommandExecutionFacade(automationInfoMock);

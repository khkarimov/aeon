...
public class HasCommand extends WebControlCommand {
    ...
    /**
     * Initializes a new instance of the HasCommand
     *
     ...
     */
    public HasCommand(IBy selector, ICommandInitializer commandInitializer, String[] messages, String childSelector, ComparisonOption option, String attribute) {

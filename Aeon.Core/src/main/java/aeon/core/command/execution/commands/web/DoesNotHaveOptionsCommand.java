...
public class DoesNotHaveOptionsCommand extends WebControlCommand {
     ...
     */
    public DoesNotHaveOptionsCommand(IBy selector, ICommandInitializer commandInitializer, String[] options, WebSelectOption select) {
     ...
     * @param select             The way the options will be searched, either WebSelectOption.Text or WebSelectOption.Value.
     */
    public DoesNotHaveOptionsCommand(IBy selector, ICommandInitializer commandInitializer, String[] options, String optgroup, WebSelectOption select) {
        super(String.format(Locale.getDefault(), Resources.getString("DoesNotHaveOptionsCommand_Info"), options, selector), selector, commandInitializer);
        this.options = options;

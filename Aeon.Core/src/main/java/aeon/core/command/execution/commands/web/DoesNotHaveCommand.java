...
public class DoesNotHaveCommand extends WebControlCommand {
     ...
     */
    public DoesNotHaveCommand(IBy selector, ICommandInitializer commandInitializer, String[] messages, String childSelector, ComparisonOption option, String attribute) {

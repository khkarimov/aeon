...
public class SessionServiceTests {
    ...
    @Before
    public void setUp() {
        sessionService = new SessionService(supplierMock);
    }
    ...
    public void setUpAutomationInfoTest() throws Exception {
        ...
        AutomationInfo automationInfo = sessionService.setUpAutomationInfo(settingsMock);
    ...
    public void setUpAutomationInfoNullSettingsTest() throws Exception {
        ...
        AutomationInfo automationInfo = sessionService.setUpAutomationInfo(null);
    ...
    public void setUpCommandExecutionFacadeTest() {
        ...
        WebCommandExecutionFacade commandExecutionFacade = sessionService.setUpCommandExecutionFacade(automationInfoMock);

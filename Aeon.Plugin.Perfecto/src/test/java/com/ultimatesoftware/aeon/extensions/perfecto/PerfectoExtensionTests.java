...
class PerfectoExtensionTests {
    ...
    void onStartUp_isCalled_setsCorrelationId() {
        ...
        Set customFields = this.executionContextCaptor.getValue().getCustomFields();
        assertTrue(customFields.contains(new CustomField("Correlation ID", "correlationId")));
        assertTrue(customFields.contains(new CustomField("Aeon Version", Aeon.getVersion())));
    }
    ...
    void onBeforeStart_isCalled_setsCorrelationIdAndSuiteName() {
        ...
        Set customFields = this.executionContextCaptor.getValue().getCustomFields();
        assertTrue(customFields.contains(new CustomField("Correlation ID", "correlationId")));
        assertTrue(customFields.contains(new CustomField("Suite Name", "suiteName")));
        assertTrue(customFields.contains(new CustomField("Aeon Version", Aeon.getVersion())));
    }
    ...
    @Test
    void onBeforeTest_withNullClient_doesNotCallApi() {
        // Arrange
        doReturn("http://test.perfectomobile.com/test/wd/hub")
                .when(this.configuration)
                .getString(SeleniumConfiguration.Keys.SELENIUM_GRID_URL, "");
    ...
    @Test
    void onSucceededTest_withNullClient_doesNotCallApi() {
        // Arrange
        doReturn("http://test.perfectomobile.com/test/wd/hub")
                .when(this.configuration)
                .getString(SeleniumConfiguration.Keys.SELENIUM_GRID_URL, "");
    ...
    @Test
    void onSkippedTest_withNullClient_doesNotCallApi() {
        // Arrange
        doReturn("http://test.perfectomobile.com/test/wd/hub")
                .when(this.configuration)
                .getString(SeleniumConfiguration.Keys.SELENIUM_GRID_URL, "");
    ...
    @Test
    void onFailedTest_withNullClient_doesNotCallApi() {
        // Arrange
        doReturn("http://test.perfectomobile.com/test/wd/hub")
                .when(this.configuration)
                .getString(SeleniumConfiguration.Keys.SELENIUM_GRID_URL, "");
    ...
    @Test
    void onBeforeStep_withNullClient_doesNotCallApi() {
        // Arrange
        doReturn("http://test.perfectomobile.com/test/wd/hub")
                .when(this.configuration)
                .getString(SeleniumConfiguration.Keys.SELENIUM_GRID_URL, "");
    ...
    void onGenerateCapabilities_tokenUserAndPasswordProvided_setsToken() {
        ...
        when(this.adapter.getWebDriver()).thenReturn(this.androidDriver);
        doReturn(this.reportiumClient).when(this.reportiumClientFactory).createPerfectoReportiumClient(any());
        this.perfectoExtension.onAfterLaunch(this.aeonConfiguration, this.adapter);
    ...
    @Test
    void onAfterLaunch_withoutPerfectoUrl_doesNothing() {
        //Arrange
        doReturn("http://test.not-perfecto.com/test/wd/hub")
                .when(this.configuration)
                .getString(SeleniumConfiguration.Keys.SELENIUM_GRID_URL, "");

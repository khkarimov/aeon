 ...
 * </p>
 */
@Plugin(name = "EchoHtmlLayout", category = Node.CATEGORY, elementType = Layout.ELEMENT_TYPE, printObject = true)
public final class EchoHtmlLayout extends AbstractStringLayout {
    ...
    private EchoHtmlLayout(final boolean locationInfo, final String title, final String contentType, final Charset charset,
     ...
     */
    @PluginFactory
    public static EchoHtmlLayout createLayout(
        ...
        return new EchoHtmlLayout(locationInfo, title, contentType, charset, font, fontSize, headerSize);
    }
     ...
     * @return an HTML Layout.
     */
    public static EchoHtmlLayout createDefaultLayout() {
    ...
    public static class Builder implements org.apache.logging.log4j.core.util.Builder<EchoHtmlLayout> {
        ...
        @Override
        public EchoHtmlLayout build() {
            if (contentType == null) {
                contentType = DEFAULT_CONTENT_TYPE + "; charset=" + charset;
            }
            return new EchoHtmlLayout(locationInfo, title, contentType, charset, fontName, fontSize.getFontSize(),

...
public interface IAdapter {
     ...
     */
    IElement FindElement(UUID guid, IBy findBy);
     ...
     * @throws NoSuchElementException   If there is no such element.
     */
    Collection<IElement> FindElements(UUID guid, IBy findBy);
     ...
     */
    void Click(UUID guid, IElement element);
     ...
     */
    List<ICookie> GetAllCookies(UUID guid);
     ...
     */
    ICookie GetCookie(UUID guid, String name);
     ...
     */
    void AddCookie(UUID guid, ICookie cookie);

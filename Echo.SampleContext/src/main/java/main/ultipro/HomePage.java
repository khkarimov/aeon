...
public class HomePage {
    ...
    public HomePage(AutomationInfo automationInfo) {
        ...
        menuButon = new Button(automationInfo, By.CssSelector("#menuButtonContainer > div.menuButton"), new ArrayList<>()); //passing in an empty ArrayList sets the frame to the default frame
